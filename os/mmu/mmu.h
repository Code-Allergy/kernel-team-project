...
#define L1_GLOBAL \
    (0 << 17) /* User pages should be NON-GLOBAL and have an ASID attached */
...
#define L1_ACCESS_RW_NO \
    ((RAW_AP_RW_NO << L1_AP_SHIFT) | (RAW_AP2_0 << L1_AP2_SHIFT))
#define L1_ACCESS_RW_RO \
    ((RAW_AP_RW_RO << L1_AP_SHIFT) | (RAW_AP2_0 << L1_AP2_SHIFT))
#define L1_ACCESS_RW_RW \
    ((RAW_AP_RW_RW << L1_AP_SHIFT) | (RAW_AP2_0 << L1_AP2_SHIFT))
#define L1_ACCESS_RO_NO \
    ((RAW_AP_RW_NO << L1_AP_SHIFT) | (RAW_AP2_1 << L1_AP2_SHIFT))
#define L1_ACCESS_RO_RO \
    ((RAW_AP_RW_RW << L1_AP_SHIFT) | (RAW_AP2_1 << L1_AP2_SHIFT))
...
#define L1_USER_CODE_FLAGS                                         \
    (L1_ACCESS_RW_RO | L1_ACCESS_X | L1_SHAREABLE | L1_CACHEABLE | \
     L1_NON_GLOBAL)

#define L1_USER_DATA_FLAGS                                          \
    (L1_ACCESS_RW_RW | L1_ACCESS_NX | L1_SHAREABLE | L1_CACHEABLE | \
     L1_NON_GLOBAL)
...
/* Map VADDR -> PADDR with flags as a section. vaddr and paddr should be 1MB
 * aligned */
