...
#define CONTROL_MODULE_UART1_TXD_OFF 0x984
               ...
               unsigned short char_length)
{
    ...
    switch (uart_index)
    {
        ...
        case 1:
            ...
            /* initialize receive buffer*/
            circular_char_buffer_init(&uart1_rx_buffer);
            break;
        default:
            break;
    }
                    ...
                    unsigned short char_length)
{
    ...
    REG32_write_masked(base_addr, UART_MCR_OFF, 0x40, mcr_bit6);
...
void handle_uart1_irq(void)
{
    ...
    /* Re enable UART1 interrupts*/
    REG32_write(UART1_BASE, UART_IER_UART_OFF, 0x01);
