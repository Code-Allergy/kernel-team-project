...
void motor_init(void)
{
    ...
    GpioSetPinMode(GPIO1_BASE,
                   LEFT_MOTOR_PIN1 | LEFT_MOTOR_PIN2 | LEFT_MOTOR_EN |
                       RIGHT_MOTOR_PIN1 | RIGHT_MOTOR_PIN2 | RIGHT_MOTOR_EN,
                   GpioPinOut);
    GPIO_clear(GPIO1_BASE,
               LEFT_MOTOR_PIN1 | LEFT_MOTOR_PIN2 | LEFT_MOTOR_EN |
                   RIGHT_MOTOR_PIN1 | RIGHT_MOTOR_PIN2 |
                   RIGHT_MOTOR_EN); /* set all to 0 */
}
 ...
 * @param value The value associated with the command. For example, the
...
int motor_read(int motor_num, void* buf, int count)
{
    ...
    if ((pin1_value == 0 && pin2_value == 0) ||
        (pin1_value == 1 && pin2_value == 1))
        v = 0;
